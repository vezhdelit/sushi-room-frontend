...
const Item = ({ _id, title, quantity, weight, price, imageUrl, compounds }) => {
  ...
  return (
    <div className={styles.item}>
        ...
        <div className={styles.upper}>
          ...
          {isAuth && (
            <HeartIcon
              ...
              className={
                data && data.favourites.includes(_id) ? styles.active : ""
              }
            />
          )}
        </div>
      ...
      <div className={styles.itemBottom}>
        ...
        {count > 0 ? (
          <CounterButton onClickRemove={onClickRemove} onClickAdd={onClickAdd}>
            {count}
          </CounterButton>
        ) : (
